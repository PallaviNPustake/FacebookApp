...
public class Utility {
	...
	public static void takeScreenshot(WebDriver driver, String fileName) throws IOException
	{
	    ...
	    File dest = new File("C:\\Users\\palla\\EclipseWorksapce\\FacebookApp\\Screenshot\\"+fileName+"-"+str+".png");            
	...
	public static String readDataFromPropertyFile(String key) throws IOException
	{
		...
		FileInputStream myFile = new FileInputStream("C:\\Users\\palla\\EclipseWorksapce\\FacebookApp\\FacebookData.properties");
